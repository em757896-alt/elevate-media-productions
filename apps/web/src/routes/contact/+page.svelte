          ...
          <div class="glass rounded-2xl p-7 space-y-6">
            ...
            <div class="border-t border-slate-200/50 pt-5 dark:border-white/5">
              ...
              <div class="flex gap-3">
                {#each [{ icon: Github, href: site.github, label: 'GitHub' }, { icon: Reddit, href: site.reddit, label: 'Reddit' }, { icon: Linkedin, href: site.linkedin, label: 'LinkedIn' }, { icon: Twitter, href: site.twitter, label: 'Twitter' }] as social}
